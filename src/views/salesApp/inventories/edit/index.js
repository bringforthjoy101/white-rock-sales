...
const UserEdit = () => {
	...
	const [activeTab, setActiveTab] = useState('1'),
		store = useSelector((state) => state.inventories),
	...
	useEffect(() => {
		dispatch(getInventory(parseInt(id)))
	}, [dispatch])
						...
						<Nav pills>
							<NavItem>
								<NavLink active={activeTab === '1'} onClick={() => toggle('1')}>
									<User size={14} />
									<span className="align-middle d-none d-sm-block">Inventory</span>
								</NavLink>
							</NavItem>
							{/* <NavItem>
                ...
                <NavLink active={activeTab === '3'} onClick={() => toggle('3')}>
                  ...
                  <span className='align-middle d-none d-sm-block'>Social</span>
						...
						<TabContent activeTab={activeTab}>
							<TabPane tabId="1">
								<AccountTab selectedInventory={store.selectedInventory} />
							</TabPane>
							{/* <TabPane tabId='2'>
                <InfoTab />
              </TabPane>
