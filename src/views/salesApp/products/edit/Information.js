...
import { AvForm, AvGroup, AvInput, AvRadioGroup, AvCheckboxGroup, AvRadio, AvCheckbox } from 'availity-reactstrap-validation-safe'
			...
			<Row className="mt-1">
				...
				<Col lg="4" md="6">
					<AvGroup>
						...
						<AvInput type="url" id="website" name="website" placeholder="https://google.com" value="https://rowboat.com/insititious/Angelo" />
					</AvGroup>
				</Col>
				<Col lg="4" md="6">
					<FormGroup>
